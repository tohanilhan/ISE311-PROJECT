...
<<div class="header_navbar_page" id="header_navbar_page">
    ...
    <div class="row">
      <div class="column-1_shopping_chart_page">
        <div class="card-1">
          <img src="1.jpg"></img>
          <div>
              <div class="column-1-inside-1_shopping_cart_page">
                    <h3>Standart Kalıp Ekose Ceket</h3>
                    <p style="opacity: 40%;">456w84654</p>
                    <p style="margin-top: 100px;">Beden: L</p>
                    <p>Renk: Krem</p>
              </div>
              <div class="column-1-inside-2_shopping_cart_page">
                    <h2 style="color: blue;">179,99 TL</h2>
                    <button class="button_chart_shopping_cart_page"><i class="far fa-trash-alt" style="color: grey; opacity: 50%;"></i></button>
                    <button class="button_chart_shopping_cart_page"><i class="far fa-heart" style="color: grey; opacity: 50%;"></i></button>    
              </div>
          </div>
          </div>
          <hr class="hr_shopping_chart_page">
          <div class="card-1">
            <img src="3.jpg"></img>
            <div>
                <div class="column-1-inside-1_shopping_cart_page">
                      <h3>Rahat Kalıp Bisiklet Yaka Baskılı Kalın Sweatshirt</h3>
                      <p style="opacity: 40%;">456w84654</p>
                      <p style="margin-top: 100px;">Beden: M</p>
                      <p>Renk: Gri</p>
                </div>
                <div class="column-1-inside-2_shopping_cart_page">
                      <h2 style="color: blue;">59,99 TL</h2>
                      <button class="button_chart_shopping_cart_page"><i class="far fa-trash-alt" style="color: grey; opacity: 50%;"></i></button>
                      <button class="button_chart_shopping_cart_page"><i class="far fa-heart" style="color: grey; opacity: 50%;"></i></button>    
                </div>
            </div>
            ...
            <div class="card-1">
                ...
                <div>
                    <div class="column-1-inside-1_shopping_cart_page">
                          <h3>Rahat Kalıp Bisiklet Yaka Basic Sweatshirt</h3>
                          <p style="opacity: 40%;">456w84654</p>
                          <p style="margin-top: 100px;">Beden: XL</p>
                          <p>Renk: Siyah</p>
                    </div>
                    <div class="column-1-inside-2_shopping_cart_page">
                          <h2 style="color: blue;">54,99 TL</h2>
                          <button class="button_chart_shopping_cart_page"><i class="far fa-trash-alt" style="color: grey; opacity: 50%;"></i></button>
                          <button class="button_chart_shopping_cart_page"><i class="far fa-heart" style="color: grey; opacity: 50%;"></i></button>    
                    </div>
                </div>
                ...
                <hr class="hr_shopping_chart_page">
                <div class="card-1">
                    <img src="l_20202-0whs33z8-cvl_a.jpg"></img>
                  
                    <div>
                        <div class="column-1-inside-1_shopping_cart_page">
                              <h3>Uzun Kollu Basic Tişört</h3>
                              <p style="opacity: 40%;">456w84654</p>
                              <p style="margin-top: 100px;">Beden: XL</p>
                              <p>Renk: Siyah</p>
                        </div>
                        <div class="column-1-inside-2_shopping_cart_page">
                              <h2 style="color: blue;">139,99 TL</h2>
                              <button class="button_chart_shopping_cart_page"><i class="far fa-trash-alt" style="color: grey; opacity: 50%;"></i></button>
                              <button class="button_chart_shopping_cart_page"><i class="far fa-heart" style="color: grey; opacity: 50%;"></i></button>    
                        </div>
                    </div>
          ...
          <div class="column-2 topright_shopping_chart_page" style="margin-top: 160px; padding-left:80px; ">
        <div class="card-2_shopping_cart_page">
          <h2 style="text-align: left;">SİPARİŞ ÖZETİ</h2>
          <div>
            <div class="column-2-inside-1_shopping_cart_page">
                <p>Ürün Toplam</p>
                <p style="font-weight: bold;">İndirimler</p>
                <p>Ara Toplam</p>
                <p style="font-weight: bold;">Kargo Ücreti<i class="fa fa-info-circle" style="margin-left: 5px;"></i></p> 
                <p style="color: blue; font-weight: bold;">GENEL TOPLAM</p>
                <hr>
                <p>Kampanya Kodu Gir</p>
            </div>
           <div class="column-2-inside-2_shopping_cart_page">
                <p>462,96 TL</p>
                <p>28 TL</p>
                <p>434,96 TL</p>
                <p style="font-weight: bold;">BEDAVA</p>
                <p style="color: blue; font-weight: bold;">434,96 TL</p>
                <hr>
                <p>+</p>
          </div>
        </div>
            <button class="btn-ödeme_shopping_cart_page">ÖDEME ADIMINA GEÇ</button>
        </div> 
