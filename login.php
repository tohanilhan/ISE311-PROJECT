...
<div class="header_navbar_page" id="header_navbar_page">
    ...
    <form action="/action_page.php" style="max-width:500px;margin:auto;margin-top:300px ;">

    <h2 style="margin-bottom: 15px;">ÜYE GİRİŞİ</h2>
        <div class="input-container_login_page">
        <i class="fa fa-envelope icon_login_page"></i>
        <input class="input-field_login_page" type="text" placeholder="E-Posta Adresiniz" name="name"/>
        </div>

        <div class="input-container_login_page">
        <i class="fa fa-key icon_login_page"></i>
        <input class="input-field_login_page"  type="password" placeholder="Şifreniz" name="password">
        </div>
<br>
        <div>

        <div style="font-size: 18px;float: left; opacity: 0.5;">
    <input style="margin-right: 10px; " type="checkbox" name="checkbox4" value="false";>Beni hatırla
        </div>
        <div>
    <p style="font-size: 18px; float: right; opacity: 0.5;color: black;">Şifremi Unuttum</p>
        </div>

        </div>

        <input style="margin-top: 15px;" class="btn_login_page" type="submit" value="Giriş Yap">

        <p style="text-align: center;font-size: 15px; margin-top: 20px;">veya</p>  
        <p style="text-align: center; font-size: 18px; margin-top: 10px;">Henüz üye değil misin? <a class="login_page" href="signup.php" style="color: cornflowerblue;">Üye Ol</a></p>
        
        
    </form>
    <div class="footer_footer_page" style="margin-top: 900px;">
